...
namespace mys
{
    ...
    public:
        ...
        MyString &to_upper(); MyString &to_lower();
        // Friends
        template <typename U>
    ...
    template <typename T>
    MyString<T>::MyString(MyString &string)
    {
    ...
    template <typename T>
    MyString<T>::MyString(MyString<T> && string)
    {
        alloc = std::move(string.alloc); 
        M_size = string.M_size;
        str = string.str;
    ...
    MyString<T> &MyString<T>::operator=(MyString<T> && string)
    {
        MyString<T> dum(std::move(string));
        swap(*this , dum);
        return *this;
    }
